...
const App = () => {
  ...
  // Get posts from database and add data to state
  const fetchPosts = () => {
  ...
  // on componentDidMount run fetchPosts function
  useEffect(() => {
    fetchPosts()
  }, [])
  ...
  return(
    <div className="container pb-5">
        ...
        {/* Loop through each array item in state and render as a readable UI element */}
        {
          posts.map((post, i) => (
